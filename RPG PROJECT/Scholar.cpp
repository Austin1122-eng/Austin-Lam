...
int Scholar::Explosion(int dmg){                    //high base damage, can backfire and deal damage to self
    energy -= 45;
    int basedmg = 51+ ceil(floor*2.25);
    dmg += basedmg;
    srand(time(0));
...
int Scholar::Smite(int dmg){                        //lower base damage, chance to crit
    energy -= 30;
    int basedmg = 27+ floor*4;
    dmg += basedmg;
    srand(time(0));
    int crit = rand() % 101;
    if(crit <= 25){
...
int Scholar::Typhoon(int dmg){                          //medium base damage, chance to inflict weak
    energy -= 40;
